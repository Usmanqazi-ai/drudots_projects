...
public class SeatSelectionAdapter extends RecyclerView.Adapter<SeatSelectionAdapter.ViewHolder> {
    ...
    public SeatSelectionAdapter(ArrayList<SeatSelectionModel> seatSelectionModelArrayList, ItemClickListener itemClickListener, int numColumns) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ViewHolder viewHolder = new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.bus_seat_selection, parent, false));
        return viewHolder;
    }
